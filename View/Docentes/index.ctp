<div class="docentes index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $docente['Docente']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $docente['Docente']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $docente['Docente']['id']), null, __('Are you sure you want to delete # %s?', $docente['Docente']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
